...
export const BaseUrlWorkout = 'https://staging-healthhero-be.mtechub.com/workout_plan/';
export const BaseUrlCategory = 'https://staging-healthhero-be.mtechub.com/workout_category/';
export const BaseUrlPlan = 'https://staging-healthhero-be.mtechub.com/user_plans/';
export const BaseUrlRest= 'https://staging-healthhero-be.mtechub.com/restTime/';
export const BaseUrlCountDown= 'https://staging-healthhero-be.mtechub.com/countdown/';
