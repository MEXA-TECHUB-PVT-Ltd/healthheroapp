...
//   //   await AsyncStorage.setItem('ArrayData', dataArrayReminder);
//   // };
//   const [selectItem, setSelectItem] = useState([]);
//   const SaveDraft = async post => {
//     console.log(post, 'fds');
//     await AsyncStorage.getItem('dataArray')
//       .then(async draft => {
//         const c = draft ? JSON.parse(draft) : [];
//         c.push(post);
//         await AsyncStorage.setItem('dataArray', JSON.stringify(c));
//       })
//       .then(() => true);
//   };
//   useEffect(async () => {
