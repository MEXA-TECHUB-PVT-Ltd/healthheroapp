...
const SevenFourWorkout = ({navigation, route}) => {
  const {item, exercise_done, imageBackground, upcomingData} = route.params
    ? route.params
    : '';
  // console.log(exercise_done, upcomingData, 'sfsdf ');
    ...
    <View
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{flex: 1}}>
        ...
        <View
          ...
          <ScrollView
            horizontal={true}
            style={{paddingBottom: responsiveHeight(3), flex: 1}}>
            <FlatList
              data={item?.exercises}
                  ...
                  <TouchableOpacity
                    ...
                    {item?.exercise_details ? (
                      <Image
                        ...
                        source={{
                          uri:
                            `${BaseUrl}` + item?.exercise_details[0]?.animation,
                        }}
                        style={{
